...
function Saved() {
    ...
    const getSavedJobs = async (unsaveStatus) => {

        // This condition is used to enable the shimmer only when the page is mounted
        // and it prevent the shimmer when the function is called from unsave function
        if (!unsaveStatus) setShimmerStatus(true)
    ...
    const unSave = async (object) => {
        ...
        // The true is passed to disable shimmer
        getSavedJobs(true)
            ...
            <section id='jobs-saved'>
                ...
                <div id="job-saved-listing">

                    {
                        ...
                        shimmerStatus ? <Shimmer saved={true} /> :
